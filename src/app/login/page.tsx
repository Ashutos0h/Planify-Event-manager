    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res?.error) {
                ...
                router.push("/dashboard/user"); // Or agency based on logic eventually
            }
        } catch (err) {
            console.error(err);
        ...
        <div className="min-h-screen bg-background text-foreground font-sans flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                ...
                <div className="glass rounded-2xl p-8 border border-white/10">
                    ...
                    <p className="text-zinc-500 text-center mb-6">Login to your Planify account</p>

                    {error && (
                        <div className="p-3 bg-red-100 border border-red-200 text-red-600 rounded-lg text-sm mb-4">
                            {error}
                        </div>
                    )}
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="flex items-center justify-between text-sm">
                            <label className="flex items-center gap-2 cursor-pointer">
                                <input type="checkbox" className="rounded border-zinc-300 text-saffron focus:ring-saffron" />
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <button className="flex items-center justify-center gap-2 py-2 px-4 rounded-lg border border-zinc-200 dark:border-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors">
                    ...
                    <p className="text-center text-sm text-zinc-500 mt-6">
                        ...
                        <Link href="/signup" className="text-saffron font-medium hover:underline">
                            Sign up
                        </Link>
                    </p>
                </div>
